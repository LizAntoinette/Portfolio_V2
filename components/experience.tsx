            ...
            <div className="flex m-auto w-3/5 flex-col"  data-aos="fade-left">
                ...
                <div className="flex m-auto w-100">
                    <div className="w-1/3 h-96 text-base">
                        <button
                            className={`experience-tab block border-l-[1px] py-6 px-5 w-full text-left ${
                    ...
                    <div className="w-2/3 h-96 px-5 text-primary">
                        <div
                            data-aos="fade-left"
                        ...
                        >
                            ...
                            <ul className='list-disc pl-4 space-y-4 text-justify text-sm text-secondary leading-relaxed'>
                        ...
                        >
                            <p className='font-bold text-xl text-primary'>Software Engineer<span className='company-color'> @ Senarysoft LLC</span></p>
                            <p className='mt-2 mb-6 text-sm font-semibold'>Feb 2022 - June 2023</p>
                            
                            <ul className='list-disc pl-4 space-y-4 text-justify text-sm text-secondary'>
                        ...
                        >
                            <p className='font-bold text-xl text-primary'>Computer Science Lecturer<br></br><span className='company-color'> @ Eastern Samar State University</span></p>
                        ...
                        >
                            <p className='font-bold text-xl text-primary'>Junior Web Developer<span className='company-color'> @ WinterWind</span></p>
