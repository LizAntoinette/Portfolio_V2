    ...
    return (
        <section id="home" className="relative flex min-h-[100svh] flex-grow items-center pt-28 pb-16 sm:pt-32 lg:py-0 z-20">
            ...
            <div className="mx-6 mt-0 max-w-3xl sm:mx-12 lg:ml-52 lg:mr-0 lg:-mt-[75px] xl:w-1/2">
                <p data-aos="fade-up" data-aos-delay="600" className="text-xl mb-3 font-medium text-name ">Hi, my name is</p>
                <h1 data-aos="fade-up" data-aos-delay="700" className="text-[clamp(2.35rem,5vw,3.3125rem)] leading-tight font-bold">Liz Antoinette Anguren</h1>
                ...
                <p data-aos="fade-up" data-aos-delay="900" className="mb-8 max-w-2xl text-lg text-secondary leading-8">I&apos;m a full-stack developer based in the Philippines, building reliable web applications and APIs with Ruby on Rails, Vue.js, React, TypeScript, and Java.</p>
