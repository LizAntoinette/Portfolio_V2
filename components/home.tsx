    ...
    return (
        <section id="home" className="mt-15 flex-grow flex items-center h-screen  z-20">
            ...
            <div className="ml-52 -mt-[75px] xl:w-1/2">
                ...
                <p data-aos="fade-up" data-aos-delay="900" className="mb-8 text-base text-zinc-200 leading-relaxed">I design, develop, and manage web projects, ensuring functionality, usability, and meeting goals while staying current with new technologies.</p>
