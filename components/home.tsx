...
export default function Home() {
    ...
    return (
        <section id="home" className="mt-15 flex-grow flex items-center h-screen  z-20">
            ...
            <div className="mx-6 sm:mx-12 lg:ml-52 lg:mr-0 -mt-[75px] max-w-3xl xl:w-1/2">
                ...
                <div data-aos="fade-up" data-aos-delay="1000" className="flex flex-wrap justify-start mt-[3.5rem] gap-4 sm:gap-8">
